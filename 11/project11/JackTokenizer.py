...
SYMBOL_SET = {ROUND_BRACKETS_LEFT, ROUND_BRACKETS_RIGHT, SQUARE_BRACKETS_LEFT,
              ...
              APPROXIMATELY, SPACE, BACKLASH, SHIFT_LEFT, SHIFT_RIGHT}
...
class JackTokenizer:
    ...
    def is_next_symbol(self) -> bool:
        return self.next_token in SYMBOL_SET
    ...
    def int_val(self) -> int:
        """
        Returns:
            str: the integer string of the current token.
    ...
    def string_val(self) -> str:
        """
        Returns:
            str: the string string of the current token, without the double
